...
public class SwipeBackLayoutHandler {
    ...
    /**
     * A Callback is used as a communication channel with the SwipeBackLayoutHandler
     ...
     * the SwipeBackLayoutHandler with more information about the state of the parent
    ...
    public static abstract class Callback {
         ...
         * invokes one of these methods, the SwipeBackLayoutHandler will enter
         ...
         * place and the SwipeBackLayoutHandler will return to {@link #STATE_IDLE}.
         * </p>
         *
         ...
         * <p>
         * SwipeBackLayoutHandler may call this method multiple times for the same view
    ...
    /**
     * Factory method to create a new SwipeBackLayoutHandler.
     *
     * @param forParent Parent view to monitor
     * @param cb        Callback to provide information and receive events
     * @return a new SwipeBackLayoutHandler instance
     */
    public static SwipeBackLayoutHandler create(ViewGroup forParent, Callback cb) {
        return new SwipeBackLayoutHandler(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new SwipeBackLayoutHandler instance
     */
    public static SwipeBackLayoutHandler create(ViewGroup forParent, float sensitivity, Callback cb) {
        final SwipeBackLayoutHandler helper = create(forParent, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }

    /**
     * Apps should use SwipeBackLayoutHandler.create() to get a new instance. This will
     ...
     * @param forParent Parent view to monitor
     */
    private SwipeBackLayoutHandler(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be a descendant "
                    + "of the SwipeBackLayoutHandler's tracked parent view (" + mParentView + ")");
        }
     ...
     * (to the best of the SwipeBackLayoutHandler's knowledge).
     * <p>
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                // A SwipeBackLayoutHandler can only manipulate one view at a time.
