...
#define WG_PACKAGE_NAME "com.privateinternetaccess.android.wireguard"
#endif
...
static void broadcast_change(void)
{
	...
	if (!pkg || strcmp(pkg, WG_PACKAGE_NAME))
		cmd("am broadcast -a com.privateinternetaccess.android.wireguard.action.REFRESH_TUNNEL_STATES " WG_PACKAGE_NAME);
}
